 ...
 */
package com.axelor.apps.base.service.team;
...
public class TeamTaskUtils {
  ...
  public void handleTaskRecurrence(TeamTask teamTask) {
  ...
  public void validateAndGenerateTasks(TeamTask teamTask) {
    TeamTaskService teamTaskService = Beans.get(TeamTaskService.class);
  ...
  public void updateNextTasks(TeamTask teamTask) {
    if (teamTask.getDoApplyToAllNextTasks()) {
      Beans.get(TeamTaskService.class).updateNextTask(teamTask);
    }
  }

  public void resetTaskFlags(TeamTask teamTask) {
    teamTask.setDoApplyToAllNextTasks(false);
    teamTask.setHasDateOrFrequencyChanged(false);
  }

  public void handleTaskCopy(TeamTask entity, TeamTask copy) {
    copy.setAssignedTo(null);
    copy.setTaskDate(null);
    copy.setPriority(null);
  }
}
