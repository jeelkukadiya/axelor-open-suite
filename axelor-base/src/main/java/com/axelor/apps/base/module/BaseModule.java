...
public class BaseModule extends AxelorModule {
  ...
  protected void configure() {
    ...
    bind(AddressUtils.class);
    bind(ICalendarEventUtils.class);
    bind(ProductUtils.class);
    bind(PartnerUtils.class);
    bind(ProductCompanyUtils.class);
    bind(TeamTaskUtils.class);
    bind(UserUtils.class);
